...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setSource("My Recipes");
        guacRecipe.setUrl("http://www.simplyrecipe.com");
        ...
        tacosRecipe.setSource("My Recipes");
        tacosRecipe.setUrl("http://www.simplyrecipe.com");
